...
object HandlerTestHarness {
    ...
    private fun buildHandlers(d: MockDependencies): Map<String, suspend (JsonObject?) -> ToolResult> {
        ...
        return mapOf(
            ...
            "click_node" to ClickNodeTool(tree, exec, a11y, cache)::execute,
            ...
            "type_append_text" to TypeAppendTextTool(tree, exec, a11y, input, cache)::execute,
            ...
            "type_clear_text" to TypeClearTextTool(tree, exec, a11y, input, cache)::execute,
